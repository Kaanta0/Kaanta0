...
def render_svg(profile: SteamProfile) -> str:
    ...
    avatar = escape(profile.avatarfull or "https://steamcommunity.com/public/images/avatars/00/000000000000000000000000000000000000000_full.jpg")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument("--vanity", help="Steam vanity URL handle (e.g. lopobia)")
    ...
    parser.add_argument("--output", default="img/lopobia-steam-showcase.svg", help="Path to write the SVG output")
