    ...
    return textwrap.dedent(
        ...
        <svg width="420" height="260" viewBox="0 0 420 260" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g filter="url(#steamCardShadow_{suffix})">
            <rect x="0" y="0" width="420" height="260" rx="26" fill="url(#steamCardGradient_{suffix})" stroke="rgba(120, 194, 255, 0.28)" />
          ...
          <g font-family="'Segoe UI', 'Inter', 'Helvetica Neue', sans-serif">
            ...
            <g transform="translate(156 118)">
              <rect width="232" height="118" rx="22" fill="rgba(12, 26, 40, 0.78)" stroke="rgba(120, 194, 255, 0.25)" />
            ...
            <a href="{escape(profile.profileurl)}" target="_blank" rel="noreferrer">
              <rect x="322" y="32" width="72" height="30" rx="12" fill="rgba(18, 42, 60, 0.75)" stroke="rgba(120, 194, 255, 0.4)" />
              <text x="358" y="51" font-size="12" font-weight="600" fill="#F5FAFF" text-anchor="middle">View</text>
            </a>
          </g>
        </svg>
        """
